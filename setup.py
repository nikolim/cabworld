...
setup(name='gym_cabworld',
      ...
      data_files=[
          ...
          ('/gym_cabworld/images', [os.path.join('gym_cabworld/images/', 'small_map_gen.png')]),
          ('/gym_cabworld/images', [os.path.join('gym_cabworld/images/', 'cab.png')]),
          ('/gym_cabworld/images', [os.path.join('gym_cabworld/images/', 'person_1.png')]),
          ('/gym_cabworld/images', [os.path.join('gym_cabworld/images/', 'person_2.png')]),
          ('/gym_cabworld/images', [os.path.join('gym_cabworld/images/', 'person_3.png')]),
